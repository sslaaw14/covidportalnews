...
public class NewsData {
    private static String[] newsNames = {
            "Ahmad Dahlan",
            "Ahmad Yani",
            "Sutomo",
            "Gatot Soebroto",
    ...
    private static int[] newsImages = {
            R.drawable.dummies_pic1,
            R.drawable.dummies_pic2,
            R.drawable.dummies_pic3,
            R.drawable.dummies_pic2,
            R.drawable.dummies_pic1,
            R.drawable.dummies_pic3,
            R.drawable.dummies_pic1,
    ...
    public static ArrayList<Data> getListData() {
        ...
        for (int position = 0; position < newsNames.length; position++) {
            Data data = new Data();
            data.setName(newsNames[position]);
            data.setDetail(newsDetails[position]);
            data.setPhoto(newsImages[position]);
            list.add(data);
        }
        return list;
    }
